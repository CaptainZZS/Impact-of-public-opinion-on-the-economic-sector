...
os.chdir(r'E:/Python编程/zzs_project/舆论舆情对经济板块影响/数据/金融数据/银行')
dir = os.getcwd()
dirs = os.listdir(dir)
...
def operation2(x,y1,y2):
    ...
    plt.savefig('E:/Python编程/zzs_project/舆论舆情对经济板块影响/数据/图/银行/'+'银行板块'+'.png')
    plt.show()
...
def main():
    ...
    workbook.save('E:/Python编程/zzs_project/舆论舆情对经济板块影响/数据/金融数据/银行/银行板块数据.xls')
    print('已将数据保存至excel！')
main()