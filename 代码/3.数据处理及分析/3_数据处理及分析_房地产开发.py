...
#os.chdir(r'E:/Python编程/zzs_project/舆论舆情对经济板块影响/数据/金融数据/房地产开发')
...
def operation2(x,y1,y2):
    ...
    plt.savefig('F:/Python编程/zzs_project/舆论舆情对经济板块影响/数据/图/房地产开发/'+'房地产开发板块'+'.png')
    plt.show()
...
def main():
    ...
    workbook.save('E:/Python编程/zzs_project/舆论舆情对经济板块影响/数据/金融数据/房地产开发/房地产开发板块数据.xls')
    print('已将数据保存至excel！')
main()