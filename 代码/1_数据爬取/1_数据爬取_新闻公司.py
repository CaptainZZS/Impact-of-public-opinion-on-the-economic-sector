...
url = "https://finance.sina.com.cn/7x24/?tag=3"
driver.get(url)
time.sleep(5)
...
workbook.save('F:/Python编程/zzs_project/舆论舆情对经济板块影响/数据/新闻/新浪财经新闻爬取公司.xls')
#workbook.save('C:/Users/Captain/Desktop/舆论舆情对经济板块影响/数据/新闻/新浪财经新闻爬取公司.xls')
print('已将数据保存至excel！')
